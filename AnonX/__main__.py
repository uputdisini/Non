...
async def init():
    ...
    try:
        await Anon.stream_call(
            "https://telegra.ph/file/7910d14c4dd70bea9ddb2.jpg"
        )
    ...
    LOGGER("AnonX").info("Music Bot Started Successfully, Now Gib your girlfriend chumt to @uputtrobot")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("AnonX").info("Stopping Music Bot, Love U (Stopping)")
